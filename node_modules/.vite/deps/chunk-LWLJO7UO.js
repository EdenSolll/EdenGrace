...
function $458b0a5536c1a7cf$export$40bfa8c7b0832715(value, defaultValue, onChange) {
  ...
  let isControlledRef = (0, import_react8.useRef)(value !== void 0);
...
var $3b117e43dc0ca95d$export$27c701ed9e449e99 = (0, import_react24.default).forwardRef(({ children, ...props }, ref) => {
  ref = (0, $df56164dff5785e2$export$4338b53315abf666)(ref);
  let { pressProps } = (0, $f6c31cce2adf654f$export$45712eceda6fad21)({
    ...props,
    ref
  });
  let child = (0, import_react24.default).Children.only(children);
  return (0, import_react24.default).cloneElement(
    child,
    // @ts-ignore
    {
      ref,
...
var $f1ab8c75478c6f73$export$3351871ee4b288b8 = (0, import_react25.default).forwardRef(({ children, ...props }, ref) => {
  let isRegistered = (0, import_react25.useRef)(false);
  let prevContext = (0, import_react25.useContext)((0, $ae1eeba8b9eafd08$export$5165eccb35aaadb5));
  ...
  return (0, import_react25.default).createElement((0, $ae1eeba8b9eafd08$export$5165eccb35aaadb5).Provider, {
    value: context
  }, children);
});
...
var $b5e257d569688ac6$var$SSRContext2 = (0, import_react27.default).createContext($b5e257d569688ac6$var$defaultContext2);
var $b5e257d569688ac6$var$IsSSRContext2 = (0, import_react27.default).createContext(false);
...
function $b5e257d569688ac6$var$useCounter2(isDisabled = false) {
  let ctx = (0, import_react27.useContext)($b5e257d569688ac6$var$SSRContext2);
...
function $b5e257d569688ac6$var$useModernSSRSafeId2(defaultId) {
  ...
  let [didSSR] = (0, import_react27.useState)($b5e257d569688ac6$export$535bd6ca7f90a2732());
  let prefix = didSSR || false ? "react-aria" : `react-aria${$b5e257d569688ac6$var$defaultContext2.prefix}`;
  return defaultId || `${prefix}-${id}`;
}
var $b5e257d569688ac6$export$619500959fc48b262 = typeof (0, import_react27.default)["useId"] === "function" ? $b5e257d569688ac6$var$useModernSSRSafeId2 : $b5e257d569688ac6$var$useLegacySSRSafeId2;
...
function $b5e257d569688ac6$export$535bd6ca7f90a2732() {
  if (typeof (0, import_react27.default)["useSyncExternalStore"] === "function") return (0, import_react27.default)["useSyncExternalStore"]($b5e257d569688ac6$var$subscribe2, $b5e257d569688ac6$var$getSnapshot2, $b5e257d569688ac6$var$getServerSnapshot2);
  return (0, import_react27.useContext)($b5e257d569688ac6$var$IsSSRContext2);
}
...
//# sourceMappingURL=chunk-LWLJO7UO.js.map
